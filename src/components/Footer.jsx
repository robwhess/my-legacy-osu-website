...
function Footer() {
  return (
    <FooterContainer>
      ...
      The source code is <a href="https://github.com/robwhess/my-legacy-osu-website" target="_blank" rel="noopener noreferrer">on GitHub <FontAwesomeIcon icon={faGithub} /></a>.
    </FooterContainer>
  );
}
